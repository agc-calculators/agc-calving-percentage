...
class AgcCalvingPercentageResults {
    constructor() {
        this.socket = "";
        this.ready = false;
    }
        ...
        return (h("section", { "data-wizard-results": true, ref: c => this.section = c },
            ...
            h("div", { style: { display: this.ready ? 'block' : 'none' } }, this.data && (h("ul", { class: "agc-results" },
                h("li", null,
                    ...
                    h("span", { class: "agc-results__value" }, this.data['calvingPercentage']),
                    h("sub", null, "%")))))));
    }
    handleResults(e) {
    ...
    static get is() { return "agc-calving-percentage-results"; }
...
export { AgcCalvingPercentageResults };
